...
def link_shaders(program_id):
	gl.glVertexAttribPointer(
		gl.glGetAttribLocation(program_id, 'vin_position'),
		3,
		gl.GL_FLOAT,
		gl.GL_FALSE,
		0,
		None)
	gl.glEnableVertexAttribArray(gl.glGetAttribLocation(program_id, 'vin_position'))
	gl.glUseProgram(program_id)

def render(vertex_data):
...
def main():
	...
	clear_background([0.5, 0.5, 0.5, 1.0])
